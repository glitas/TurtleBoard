			...
			<div class="row content">
				...
				<div class="col-sm-8 text-left"> 
					...
					<div align="center" style="background-image:url(img/guidelines.jpg);">
							<img src="img/beginner1.png" alt="beginners" style="width:200px;height:160px;" />
							<strong><br/>
							Welcome to the <font color="#2ECC71">:turtle:</font>Board tutorial for newbies in Turtle.<br/><br/>
							This tutorial is specially constructed for new learners that have never heard about Turtle before.
